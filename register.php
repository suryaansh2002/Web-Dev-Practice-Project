	...
	$.ajax({
		...
		success: function(html){
			if (html=='true'){
				...
				$("#add_err2").html('<div class="alert alert-danger">  \<strong> Last  Name </strong>required! \</div>');
			} else if (html=='fname'){
				$("#add_err2").html('<div class="alert alert-danger">  \<strong> First Name </strong>required! \</div>');
			} else if (html=='eshort'){
				$("#add_err2").html('<div class="alert alert-danger">  \<strong> Email </strong>required! \</div>');
			} else if (html=='pshort'){
				$("#add_err2").html('<div class="alert alert-danger">  \<strong> Password</strong> required! \</div>');
			} else if (html=='eformat'){
				$("#add_err2").html('<div class="alert alert-danger">  \<strong> Email Address </strong>format not valid! \</div>');
			} else{
