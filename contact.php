                ...
                $.ajax({
                    ...
                    success: function (html) {
                        if (html == 'true') {
                            ...
                            $("#add_err2").html('<div class="alert alert-danger"> \
                                                 <strong>Message</strong> must cannot exceed 200 characters. \ \
                                                 </div>');
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="box">
				...
				<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3304.4555155328326!2d-118.34106388538783!3d34.083469423532506!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x80c2b8d36cb40581%3A0xe92d0cfe124170cf!2s3481%20Melrose%20Ave%2C%20Los%20Angeles%2C%20CA%2090038%2C%20USA!5e0!3m2!1sen!2sin!4v1600198046090!5m2!1sen!2sin" width="100%" height="450" frameborder="0" style="border:0;" allowfullscreen="" aria-hidden="false" tabindex="0"></iframe>                </div>
                <div class="col-md-4">
                    <p>Phone:
                        <strong>123.456.7890</strong>
                    </p>
                    <p>Email:
                        <strong><a href="mailto:info@thepeerfectcup.com">info@theperfectcup.com</a></strong>
                    </p>
                    <p>Address:
                    ...
                    <form role="form">
                        <div class="row">
                            <div class="form-group col-lg-4">
                                <label>Name</label>
                                <input type="text" class="form-control" name="fname" id="fname" maxlength="50">
                            </div>
                            <div class="form-group col-lg-4">
                            ...
                            <div class="form-group col-lg-12">
                                <label>Message</label>
                                <textarea class="form-control" rows="6" maxlength="200" name="message" id="message"></textarea>
                            </div>
                            <div class="form-group col-lg-12">
